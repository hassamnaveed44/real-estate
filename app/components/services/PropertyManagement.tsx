...
export default function PropertyValue({ variant = "management" }: PropertyValueProps) {
  ...
  return (
    <section className="w-full bg-[#141414] text-white py-12 lg:py-16 px-4 sm:px-8 lg:px-12 flex justify-center border-t border-[#262626]">
            ...
            >
              ...
              <div className="relative w-11 h-11 flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 60 60">
                  <defs>
                    <linearGradient id={`pm-grad-${variant}-${index}`} x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <circle
                    ...
                    r="28"
                    fill="none"
                    stroke={`url(#pm-grad-${variant}-${index})`}
                    strokeWidth="1.5"
                  />
                </svg>
