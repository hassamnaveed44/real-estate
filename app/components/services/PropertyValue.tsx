  ...
  return (
    <section className="w-full bg-[#141414] text-white py-[80px] flex justify-center">
      <div className="w-full max-w-[1720px] px-[162px] max-lg:px-[80px] max-md:px-[16px] flex flex-col gap-[80px] max-lg:gap-[40px]">
        ...
        {/* Text Container - Fully Expanded Width */}
        <div className="relative flex flex-col gap-[14px] max-md:gap-[8px] w-full">
          {/* Decorative Sparkles */}
          ...
          <p className="text-[18px] max-lg:text-[16px] max-md:text-[14px] font-medium text-[#999999] leading-[150%] w-full max-w-none">
            {paragraph}
          </p>
        </div>
